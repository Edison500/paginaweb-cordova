<script>
	...
	const faqs = [
		...
		{ q: 'What areas do you serve?',                       a: 'We serve 11 cities: Pensacola, Gulf Breeze, Navarre, Fort Walton, Crestview, Milton, Daphne, Mobile, Gulf Shores, Orange Beach, and Foley.',                                                             icon: 'bi-geo-alt-fill',         category: 'Service Areas' },
