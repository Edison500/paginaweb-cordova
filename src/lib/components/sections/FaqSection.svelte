<script>
	...
	const faqs = [
		...
		{ q: 'What areas do you serve?',                       a: 'We serve 11 cities: Pensacola, Gulf Breeze, Navarre, Fort Walton, Crestview, Milton, Orange Beach, Gulf Shores, Foley, Daphne, and Mobile.',                                                             icon: 'bi-geo-alt-fill',         category: 'Service Areas' },
